# MUSA509 Final: Car Crashes Prediction
Team: Yuhao Jia, Hanzhi Zhang

This is a MUSA Capstone Project. We want to build up a data pipeline for the prediction model. 
...
### 3.2 Preparing (i.e. little-t transforming)
